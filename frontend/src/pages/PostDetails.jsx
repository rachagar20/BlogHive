        ...
        <div className="px-8 md:px-[200px] mt-8 pb-5">
          <div className="bg-white shadow-md rounded-lg p-6">
            <div className="flex xs:flex-col sm:flex-row justify-between items-center">
              <h1 className="text-3xl xs:text-center sm:text-left font-bold text-gray-800">{post.title}</h1>
              {user?._id === post?.userId &&
                <div className="flex items-center xs:mt-4 sm:mt-0 space-x-2">
            ...
            <div className="flex xs:flex-col sm:flex-row items-center justify-between mt-4">
            ...
            <div className="flex flex-wrap items-center mt-8 font-semibold overflow-hidden">
              <p className="mr-2">Categories:</p>
              <div className="flex flex-wrap space-x-2">
                {post.categories?.map((c, i) => (
                  <div key={i} className="bg-gray-300 rounded-lg px-3 py-1 text-gray-800 mb-2">{c}</div>
                ))}
              </div>
            </div>
          </div>
